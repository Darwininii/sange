...
function ToastCard({
  ...
  return (
    <div
      className={cn(
        'group pointer-events-auto flex w-90 max-w-[calc(100vw-2rem)] shrink-0 items-start gap-3 rounded-3xl bg-surface px-4 py-3 shadow-lg shadow-black/40 ring-1 ring-border transition-all duration-200',
